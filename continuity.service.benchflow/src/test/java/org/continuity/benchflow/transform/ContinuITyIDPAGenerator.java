...
public class ContinuITyIDPAGenerator {
	...
	public ApplicationAnnotation setupAnnotation(Application system) {
		...
		extr1.setFrom(EndpointOrInput.endpoint(WeakReference.create(interfaceLogin)));
		...
		extr2.setFrom(EndpointOrInput.endpoint(WeakReference.create(interfaceAccount)));
		...
		extr3.setFrom(EndpointOrInput.endpoint(WeakReference.create(interfaceLogin)));
		...
		extr4.setFrom(EndpointOrInput.endpoint(WeakReference.create(interfaceConvert)));
