 ...
 * of {@link ContinuityByClassSearcher} or directly.
 *
 ...
 */
public class FindById<T extends ContinuityModelElement> implements Consumer<T> {
	 ...
	 */
	public static <T extends ContinuityModelElement> FindById<T> find(String id, Class<T> type) {
	 ...
	 */
	public FindById<T> in(ContinuityModelElement element) {
		ContinuityByClassSearcher<T> searcher = new ContinuityByClassSearcher<>(type, this::accept);
